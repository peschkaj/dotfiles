...
ln -s src/peschkaj/dotfiles/karabiner.json .config/karabiner/karabiner.json
brew install karabiner-elements
mkdir -p ~/Library/KeyBindings
ln -s ~/src/peschkaj/dotfiles/DefaultKeyBinding.dict ~/Library/KeyBindings/DefaultKeyBinding.dict
#+END_SRC
